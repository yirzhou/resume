...
\fontsize{10.5pt}{2}\selectfont
\onehalfspacing
\link[\textbf{DCache}]{https://drive.google.com/file/d/1Svd-wbXZiO84QmVKnKBp1cClJb2uvtWT/view?usp=sharing}: {\fontsize{10.8pt}{2}\selectfont A distributed, P2P, and geolocation-aware mobile storage network.\\ \par}
\link[\textbf{BDay.rs}]{https://github.com/yirzhou/IsolatedSoul/tree/main/rsbday}: A command-line tool for storing birthdays and sending reminders, written in Rust. \\
